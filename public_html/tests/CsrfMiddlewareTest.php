...
$firstInput = $csrf->renderInput();
$secondInput = $csrf->renderInput();
assertSameValue($firstInput, $secondInput, 'Repeated CSRF fields in one session should use the same stored token.');
